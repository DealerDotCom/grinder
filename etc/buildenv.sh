...
#CHECKSTYLE=/opt/checkstyle/checkstyle-3.2/checkstyle-all-3.2.jar:/opt/checkstyle/checkstyle-3.2/checkstyle-3.2-optional.jar
...
export CLASSPATH=$(cygpath -w -p "${JUNIT}:${JSSE}:${XALAN}")
