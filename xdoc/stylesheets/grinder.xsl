  ...
  <xsl:template match="html">
	...
	<style type="text/css">
	  <xsl:comment>
	    ...
	    a:link { color: rgb(0,0,128); background-color: rgb(255,255,255); text-decoration: none; font-weight: bold; }
	    a:visited { color: rgb(0,0,128); background-color: rgb(255,255,255); text-decoration: none; font-weight: bold; }
	    a:active { color: rgb(0,0,128); background-color: rgb(255,255,255); text-decoration: underline; font-weight: bold; }
	    a:hover { color: rgb(0,0,128); background-color: rgb(255,255,255); text-decoration: underline; font-weight: bold; }
